...
expName = 'Tilt exp trial'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Prisha Rao\\Downloads\\Tilt exp trial_lastrun.py',
